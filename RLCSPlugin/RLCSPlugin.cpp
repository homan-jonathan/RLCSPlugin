...
void RLCSPlugin::onLoad()
{
	...
	//cvar2.addOnValueChanged(std::bind(&RLCSPlugin::YourPluginMethod, this, _1, _2));
	...
	//gameWrapper->HookEventWithCallerPost<ActorWrapper>("FUNCTIONNAME", std::bind(&RLCSPlugin::FUNCTION, this, _1, _2, _3));
